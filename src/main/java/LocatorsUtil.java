...
public class LocatorsUtil {
    ...
    public static SelenideElement productCatalog = $x("//span[text()='Каталог']");
    ...
    public static SelenideElement pushButtonComparing = $$x("//*[name()='svg' and @title='Сравнение'] ").first();
